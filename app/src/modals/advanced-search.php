	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="tt-modal-advancedSearch">
				...
				<form class="form-default advanced-search-form">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-6">
								<input type="text" name="from" class="form-control" id="fromSearchAdvTime" placeholder="dd-mm-yyyy">
							</div>
							<div class="col-6">
								<input type="text" name="to" class="form-control" id="toSearchAdvTime" placeholder="dd-mm-yyyy">
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<button type="submit" name="advanced-search-btn" class="btn btn-secondary btn-block">Search</button>
					</div>
				</form>
			</div>
		</div>
